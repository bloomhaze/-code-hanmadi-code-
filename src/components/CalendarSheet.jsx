  ...
  return (
    <>
      ...
      <button
        type="button"
        onClick={onClose}
        className="absolute left-[327px] top-[58px] z-[47] flex h-8 w-8 items-center justify-center rounded-full"
      ...
      {/* sheet */}
      <div className="absolute left-0 top-[106px] z-[46] flex h-[706px] w-full flex-col overflow-hidden rounded-t-[24px] bg-white">
        {/* weekday header */}
